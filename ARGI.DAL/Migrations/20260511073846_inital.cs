        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAiEnabled = table.Column<bool>(type: "bit", nullable: false),
                    MinTargetMoisture = table.Column<double>(type: "float", nullable: false),
                    IsManualWateringRequested = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DomeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IrrigationSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IrrigationSchedules_Domes_DomeId",
                        column: x => x.DomeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Domes_DomeId",
                        column: x => x.DomeId,
                        principalTable: "Domes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorReadings_Domes_DomeId",
                        column: x => x.DomeId,
                        principalTable: "Domes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Domes_MacAddress",
                table: "Domes",
                column: "MacAddress",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Domes_UserId",
                table: "Domes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_IrrigationSchedules_DomeId",
                table: "IrrigationSchedules",
                column: "DomeId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_DomeId",
                table: "Notifications",
                column: "DomeId");
